...
const UltraMinimal17 = () => {
  return (
    <div className="h-80">
      <h3 className="text-lg font-semibold text-[#E8E2F4] mb-2">17 - Electric Gold</h3>
      <p className="text-sm text-[#6B6483] mb-2">Bright amber + muted purple</p>
      <div className="h-64">
        <ResponsiveLine
