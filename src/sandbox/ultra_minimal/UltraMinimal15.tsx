...
const UltraMinimal15 = () => {
  return (
    <div className="h-80">
      <h3 className="text-lg font-semibold text-[#E8E2F4] mb-2">15 - Earthy</h3>
      <p className="text-sm text-[#6B6483] mb-2">Gold + green</p>
      <div className="h-64">
        <ResponsiveLine
